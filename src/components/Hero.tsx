  ...
  const heroSlides = [
    {
      content: (
        <section className="flex flex-col items-start md:flex-row h-[500px] text-white md:items-center">
          <div className="flex flex-col justify-center items-center md:w-2/5 space-y-4 h-[100%] bg-green-700 p-8">
            ...
            <button className="px-6 py-2 bg-white text-green-700 font-semibold rounded-md hover:bg-green-100">
              Shop Now
            </button>
          </div>
